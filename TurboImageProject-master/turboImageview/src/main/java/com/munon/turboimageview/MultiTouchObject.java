...
public abstract class MultiTouchObject implements Serializable {
    ...
    PositionAndScale mLastPosAndScale;
    ...
    public boolean setPos(PositionAndScale newImgPosAndScale) {
        ...
        mLastPosAndScale = newImgPosAndScale;
    ...
    public abstract void remark(Canvas canvas);
    public abstract void unRemark(Canvas canvas) ;
